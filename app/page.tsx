                ...
                <div className="flex items-center">
                    <DropdownMenu>
                        <DropdownMenuTrigger
                            ...
                            Sort
                            <ChevronDownIcon
                                className="-mr-1 ml-1 h-5 w-5 flex-shrink-0 test-gray-400 group-hover:text-gray-500"/>
                        </DropdownMenuTrigger>
                                        ...
                                        {COLOR_FILTERS.options.map((option, optionIdx) => (
                                            <li key={option.value} className="flex items-center">
                                                <input
                                                    ...
                                                    className="h-4 w-4 rounded border-gray-300 text-indigo focus:ring-indigo-500"
                                                />
