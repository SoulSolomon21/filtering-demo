...
import {ProductFilterValidators} from "@/lib/validators/product-validators";
...
export const POST = async (req: NextRequest) => {
    try {
        ...
        const {color, size, sort, price} = ProductFilterValidators.parse(body.filter)
